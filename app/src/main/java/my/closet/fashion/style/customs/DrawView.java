...
import static my.closet.fashion.style.customs.DrawView.DrawViewAction.AUTO_CLEAR;
import static my.closet.fashion.style.customs.DrawView.DrawViewAction.MANUAL_CLEAR;
import static my.closet.fashion.style.customs.DrawView.DrawViewAction.ZOOM;
...
public class DrawView extends View {
    ...
    public void setButtons(ImageButton undoButton, ImageButton redoButton) {
    ...
    private static class AutomaticPixelClearingTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        private WeakReference<my.closet.fashion.style.customs.DrawView> drawViewWeakReference;

        AutomaticPixelClearingTask(my.closet.fashion.style.customs.DrawView drawView) {
